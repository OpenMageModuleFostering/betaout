...
class Betaout_Amplify_Model_Core_Config
    extends Betaout_Amplify_Model_Core_Config_Base
{
    //  {{{ properties
    ...
    public function __construct($sourceData = null)
    {
        ...
        $this->_prototype     = new Betaout_Amplify_Model_Core_Config_Base();
    ...
    public function getResourceModel()
    {
        if (is_null($this->_resourceModel)) {
            $this->_resourceModel = Mage::getResourceModel('betaout_amplify/core_config');
        }
    ...
    public function loadModules()
    {
        ...
        $mergeToObject  = Mage::getModel('betaout_amplify/core_config_base');
    ...
    protected function _loadDeclaredModules($mergeConfig = null)
    {
        ...
        $unsortedConfig = new Betaout_Amplify_Model_Core_Config_Base();
        $unsortedConfig->loadString('<config/>');
        $fileConfig = new Betaout_Amplify_Model_Core_Config_Base();
        ...
        $sortedConfig = new Betaout_Amplify_Model_Core_Config_Base();
     ...
     *
     * @return Betaout_Amplify_Model_Core_Config_Base|Mage_Core_Model_Config_Base
     */
    public function loadModulesConfiguration($fileName, Betaout_Amplify_Model_Core_Config_Base $mergeToObject = null, $mergeModel = null)
    {
